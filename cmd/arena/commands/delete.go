...
func NewDeleteCommand() *cobra.Command {
	...
	command.Flags().StringVar(&trainingType, "type", "", "The training type to delete, the possible option is tfjob, mpijob, mxjob, pytorchjob, sparkjob, volcanojob, horovodjob or standalonejob. (optional)")
